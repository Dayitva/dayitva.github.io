...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<i18n>.freeze, [">= 0.9.5".freeze, "< 2".freeze])
  s.add_runtime_dependency(%q<jekyll-sass-converter>.freeze, ["~> 2.0".freeze])
  ...
  s.add_runtime_dependency(%q<terminal-table>.freeze, ["~> 1.8".freeze])
end
